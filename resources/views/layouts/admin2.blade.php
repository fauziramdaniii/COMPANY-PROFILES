...
<body>
    <div class="container-scroller">
        <!-- partial:/template_admin/partials/_navbar.html -->
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="/template_admin/index.html"><img
                        src="/template_admin/images/logo.svg" class="mr-2" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="/template_admin/index.html"><img
                        src="/template_admin/images/logo-mini.svg" alt="logo" /></a>
            </div>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                            <img src="/template_admin/images/faces/face28.jpg" alt="profile" />
                        </a>
        ...
        <div class="container-fluid page-body-wrapper">
            <!-- partial:/template_admin/partials/_settings-panel.html -->
                    ...
                    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img src="/template_admin/images/faces/face1.jpg"
                            ...
                            <li class="list">
                                <div class="profile"><img src="/template_admin/images/faces/face2.jpg"
                            ...
                            <li class="list">
                                <div class="profile"><img src="/template_admin/images/faces/face3.jpg"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Daniel Russell</p>
                                    <p>Available</p>
                            ...
                            <li class="list">
                                <div class="profile"><img src="/template_admin/images/faces/face4.jpg"
                                        alt="image"><span class="offline"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="/template_admin/images/faces/face5.jpg"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                            ...
                            <li class="list">
                                <div class="profile"><img src="/template_admin/images/faces/face6.jpg"
                                        alt="image"><span class="online"></span></div>
                                <div class="info">
                                    <p>Sarah Graves</p>
                                    <p>Available</p>
            ...
            <!-- partial -->
            <!-- partial:/template_admin/partials/_sidebar.html -->
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="icons">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/admin/portfolios">Portfoloio</a>
                                </li>
                            </ul>
                        </div>
                        <div class="collapse" id="icons">
                        ...
                        <div class="collapse" id="icons">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/admin/testimonis">Testimoni</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
            ...
            <div class="main-panel">
                ...
                <!-- partial:/template_admin/partials/_footer.html -->
                <footer class="footer">
